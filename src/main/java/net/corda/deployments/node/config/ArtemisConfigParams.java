...
public class ArtemisConfigParams {
    ...
    public static final String ARTEMIS_TRUSTSTORE_PATH_ENV_VAR_NAME = "ARTEMIS_KEYSTORE_PATH";
    public static final String ARTEMIS_SSL_KEYSTORE_PASSWORD_ENV_VAR_NAME = "ARTEMIS_TRUSTSTORE_PASSWORD";
    public static final String ARTEMIS_TRUSTSTORE_PASSWORD_ENV_VAR_NAME = "ARTEMIS_SSL_KEYSTORE_PASSWORD";
